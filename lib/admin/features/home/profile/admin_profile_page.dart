...
import '../../../../features/auth/login/bloc/auth_event.dart';
          ...
          listener: (context, state) {
            if (state is ProfileUpdated) {
              showDialog(
                ...
                builder:
                    (context) => AlertDialog(
                      title: Text("Berhasil Menjadi Pembeli"),
                      content: Text(
                        "Selamat! Kamu sekarang kembali menjadi Pembeli.\n"
                        "Silakan login kembali untuk menggunakan aplikasi pembeli.",
                      ),
                      actions: [
                        TextButton(
                          onPressed: () {
                      ...
                      GestureDetector(
                        onTap: () async {
                          final confirmed = await showDialog<bool>(
                            ...
                            builder:
                                (context) => AlertDialog(
                                  title: Text("Konfirmasi Menjadi Pembeli"),
                                  content: Text(
                                    "Apakah kamu yakin ingin kembali sebagai pembeli?\n",
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed:
                          ...
                          if (confirmed == true) {
                            context.read<ProfileBloc>().add(BecomeBuyer());
                          }
                        },
                        child: ProfileMenu(
                          title: "Kembali Menjadi Pembeli",
